...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `exercice3` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `avoir_note` VALUES (1,1,1,10),(2,2,1,10),(3,3,1,10),(4,4,1,10),(5,5,1,10),(6,6,1,10),(7,7,1,10),(8,17,1,10),(9,18,1,10),(10,1,2,10),(11,2,2,10),(12,3,2,10),(13,4,2,10),(14,5,2,10),(15,6,2,10),(16,7,2,10),(17,17,2,10),(18,18,2,10),(19,8,3,10),(20,9,3,10),(21,10,3,10),(22,11,3,10),(23,12,3,10),(24,13,3,10),(25,14,3,10),(26,15,3,10),(27,16,3,10),(28,8,4,10),(29,9,4,10),(30,10,4,10),(31,11,4,10),(32,12,4,10),(33,13,4,10),(34,14,4,10),(35,15,4,10),(36,16,4,10),(37,17,4,10),(42,17,3,10),(43,18,4,10);
...
--
-- Temporary table structure for view `etudiant_epreuve`
--

DROP TABLE IF EXISTS `etudiant_epreuve`;
/*!50001 DROP VIEW IF EXISTS `etudiant_epreuve`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `etudiant_epreuve` AS SELECT 
 1 AS `idEtudiant`,
 1 AS `nomEtudiant`,
 1 AS `prenomEtudiant`,
 1 AS `adresseEtudiant`,
 1 AS `villeEtudiant`,
 1 AS `codePostalEtudiant`,
 1 AS `telephoneEtudiant`,
 1 AS `dateEntreeEtudiant`,
 1 AS `anneeEtudiant`,
 1 AS `remarqueEtudiant`,
 1 AS `sexeEtudiant`,
 1 AS `dateNaissanceEtudiant`,
 1 AS `HOBBY`,
 1 AS `idEpreuve`,
 1 AS `libelleEpreuve`,
 1 AS `idEnseignantEpreuve`,
 1 AS `idMatiereEpreuve`,
 1 AS `dateEpreuve`,
 1 AS `CoefficientEpreuve`,
 1 AS `anneeEpreuve`,
 1 AS `idAvoirNote`,
 1 AS `note`*/;
...
--
-- Final view structure for view `etudiant_epreuve`
--
...
/*!50001 VIEW `etudiant_epreuve` AS select `e`.`idEtudiant` AS `idEtudiant`,`e`.`nomEtudiant` AS `nomEtudiant`,`e`.`prenomEtudiant` AS `prenomEtudiant`,`e`.`adresseEtudiant` AS `adresseEtudiant`,`e`.`villeEtudiant` AS `villeEtudiant`,`e`.`codePostalEtudiant` AS `codePostalEtudiant`,`e`.`telephoneEtudiant` AS `telephoneEtudiant`,`e`.`dateEntreeEtudiant` AS `dateEntreeEtudiant`,`e`.`anneeEtudiant` AS `anneeEtudiant`,`e`.`remarqueEtudiant` AS `remarqueEtudiant`,`e`.`sexeEtudiant` AS `sexeEtudiant`,`e`.`dateNaissanceEtudiant` AS `dateNaissanceEtudiant`,`e`.`HOBBY` AS `HOBBY`,`ep`.`idEpreuve` AS `idEpreuve`,`ep`.`libelleEpreuve` AS `libelleEpreuve`,`ep`.`idEnseignantEpreuve` AS `idEnseignantEpreuve`,`ep`.`idMatiereEpreuve` AS `idMatiereEpreuve`,`ep`.`dateEpreuve` AS `dateEpreuve`,`ep`.`CoefficientEpreuve` AS `CoefficientEpreuve`,`ep`.`anneeEpreuve` AS `anneeEpreuve`,`a`.`idAvoirNote` AS `idAvoirNote`,`a`.`note` AS `note` from ((`avoir_note` `a` join `etudiants` `e` on((`a`.`idEtudiant` = `e`.`idEtudiant`))) join `epreuves` `ep` on((`a`.`idEpreuve` = `ep`.`idEpreuve`))) */;
...
-- Dump completed on 2023-10-25 15:26:29
