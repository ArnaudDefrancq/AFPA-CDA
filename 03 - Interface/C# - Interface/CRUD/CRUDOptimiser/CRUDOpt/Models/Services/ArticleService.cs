...
namespace CRUDOpt.Models.Services
{
	public class ArticleService
	{
		...
		static public string Path { get; set; } = "../../../ARticle.json";
		...
		static public List<Article> GetAllProduits()
		{
		...
		static public void SaveProduits(List<Article> liste)
		{
		...
		static public void UpdateProduit(Article a)
		//Méthode qui permet de modifier un enregistrement
		{
			List<Article> liste = GetAllProduits();
			// on recherche la position du produit dans la liste
		...
		static public void DeleteProduit(Article a)
		//Méthode qui permet de modifier un enregistrement
		{
			List<Article> liste = GetAllProduits();
			// on recherche la position du produit dans la liste
