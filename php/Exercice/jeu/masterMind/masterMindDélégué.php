 ...
 */
function initBoard(int $x, int $y): array
{
    return $board = array();
}
 ...
 */
function initCode(int $nbColor, int $codeSize): string
{
    return $code = "";
}
 ...
 */
function userInput(int $nbColor, int $codeSize): string
{
    return $attempt = "";
}
 ...
 */
function checkInput(string $attempt, int $code): string
{
    return $result = "";
}
 ...
 */
function updateBoard(string $attempt, string $result, array $board): array
{
    return $board = array();
}
 ...
 */
function checkWin(int $nbTry, string $result): int
{
    return $final = 0;
}
